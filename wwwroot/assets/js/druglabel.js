...
var DatatableJsonRemoteCreens = function () {
    ...
    var demo = function () {
        ...
        var datatable = $('.m_datatable').mDatatable({
            ...
            data: {
                type: 'remote',
                source: '/Outlet/GetDataDrugLabel',
                pageSize: 10,
            },
                ...
                ,
            {
                ...
                template: function (row, index, datatable) {
                    ...
                    return '<a href="/Drug/UpdateDrugLabel?id=' + row.id + '" class="m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill" title="Update">\
